...
Rocket Tech School - [ссылка на hh.ru](https://ekaterinburg.hh.ru/employer/5612066) 

### 📊 Проекты по анализу данных и метрик педагогов
...
### 🕷️ Проекты по парсингу и автоматизации процессов 
...
- **[Manager-Helper-Parser-Bot](https://github.com/ArtemAfonasyev/Manager-Helper-Parser-Bot)** - Бот для Discord, предназначенный для помощи менеджерам RTS School в управлении расписанием преподавателей и поиске подходящих слотов для занятий. Парсинг AlfaCrm через Api + Парсинг страницы

## 🌐 Личные проекты
- **[Сайт Кликер чреез Telegram Web App](https://github.com/ArtemAfonasyev/ClickerFlask)** - Добро пожаловать в **Пивной Кликер** - увлекательную игру в жанре кликера с пивной тематикой, которая работает как Telegram Web App! Игроки могут кликать по изображениям, чтобы зарабатывать "бобуксы", покупать улучшения, менять скины персонажей и участвовать в различных игровых механиках.
**[Telegram-WireGuard-Bot](https://github.com/ArtemAfonasyev/Telegram-WireGuard-Bot)** - Telegram-бот, который позволяет пользователям автоматически создавать и управлять персональными конфигурациями WireGuard VPN. Бот генерирует уникальные конфигурации для каждого пользователя, сохраняет их в базе данных и предоставляет удобный способ подключения к VPN через Telegram.
